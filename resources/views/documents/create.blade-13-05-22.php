                    ...
                    <div class="col-xl-4">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  <input type="text" id="date_received" name="date_received" class="form-control datepicker" placeholder=" " required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['date_received'] : '' }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  <input type="text" id="deadline" name="deadline" class="form-control datepicker" placeholder=" " required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['deadline'] : '' }}">
                        ...
                        {{-- <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                  <input data-db="status" type="text" id="status_id" name="status" class="form-control autocomp" placeholder=" " required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['status'] : '' }}">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <input data-db="employee" type="text" id="employee_id" name="focal" class="form-control autocomp" required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['focal'] : '' }}">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                  <input data-db="OriginOffice" type="text" id="origin_id" name="origin" class="form-control autocomp" required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['origin'] : '' }}">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  <input data-db="mor" type="text" id="mor_id" name="mor" class="form-control autocomp"  required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['mor'] : '' }}">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                  <input data-db="doctype" type="text" id="doctype_id" name="doctype" class="form-control autocomp" placeholder="" required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['doctype'] : '' }}">
                      ...
                      <div class="row">
                          <div class="col-sm-3">
                              ...
                              <div class="form-group{{ $errors->has('control_number') ? ' has-danger' : '' }}">
                                <input class="form-control{{ $errors->has('control_number') ? ' is-invalid' : '' }}" name="control_number" id="input-control_number" type="text" placeholder="{{ __('Control number') }}"   required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['control_number'] : '' }}"/>
                          ...
                          <div class="col-sm-9">
                              ...
                              <div class="form-group{{ $errors->has('subject') ? ' has-danger' : '' }}">
                                <input class="form-control{{ $errors->has('subject') ? ' is-invalid' : '' }}" name="subject" id="input-subject" type="text" placeholder="{{ __('Subject') }}"   required="true" aria-required="true" value="{{ Session::get('last_input') ? $last_input['subject'] : '' }}"/>
                      ...
                      {{-- <div class="row">
                          <div class="col-sm-12 mt-4">
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" id="action_taken" name="action_taken" rows="5" placeholder=" ">{{ Session::get('last_input') ? $last_input['action_taken'] : '' }}</textarea>
                                </div>
                          </div>
                      </div>                    --}}
                      <div class="row">
                          <div class="col-sm-12 mt-4">
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" id="required_action" name="required_action" rows="9" placeholder=" ">{{ Session::get('last_input') ? $last_input['required_action'] : '' }}</textarea>
                                </div>
                          </div>
                      </div>                   
                  </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="attachmentModalTitle">Upload Files {{$document_id}}</h5>
