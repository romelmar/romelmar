              ...
              <div class="card-body ">
                ...
                <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-10">
                          <div class="form-group{{ $errors->has('firstname') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}" name="firstname" id="input-firstname" type="text" value="{{ $employee->firstname}}"  required="true" aria-required="true"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-10">
                          <div class="form-group{{ $errors->has('lastname') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}" name="lastname" id="input-lastname" type="text" value="{{ $employee->lastname}}"   required="true" aria-required="true"/>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-10">
                          <div class="form-group{{ $errors->has('designation') ? ' has-danger' : '' }}">
                            <input class="form-control{{ $errors->has('designation') ? ' is-invalid' : '' }}" name="designation" id="input-designation" type="text" value="{{ $employee->designation}}"   required="true" aria-required="true"/>
                        ...
                        @if( session('image'))
                          ...
                          @else  
                          <input type="hidden" name="file_path" value="{{ $employee->file_path}}">
                        @endif
                    ...
                    <div class="col-sm-4">
                      ...
                      <img src="../{{ Session::get('image') }}" class="img-fluid rounded">
                      @elseif($employee->file_path ) 
                        <img src="../{{ $employee->file_path  }}" class="img-fluid rounded">
                      @else   
