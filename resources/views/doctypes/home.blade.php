@extends('layouts.app', ['activePage' => 'doctypes', 'titlePage' => __('Dashboard')])
            ...
            <div class="card-header card-header-tabs card-header-primary">
              <div class="nav-tabs-navigation">
                <div class="nav-tabs-wrapper">
                  <span class="nav-tabs-title">{{__("Document Types")}}</span>
                  <ul class="nav nav-tabs" data-tabs="tabs">
                    <li class="nav-item">
                      <a class="nav-link " href="{{ route("doctypes.create") }}" >
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route("doctypes.edit", $origin_office->id)}}">Edit</a>
